-- Update menu items to American food items
-- This script will delete existing items and insert new American food items
...
-- Insert American food items organized by categories
...
('Onion Rings', 'Beer-battered crispy onion rings', ARRAY['Onions', 'Flour', 'Beer', 'Spices'], 0, 5.99, 'Appetizer', true);
...
-- Note: Make sure your menu_items table has the 'is_available' column
-- If not, you can remove that column from the INSERT statements or add it to your schema
